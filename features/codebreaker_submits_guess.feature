Feature: code-breaker submits guess
    ...
    the position of a color in the secret code, a white peg is added to the mark.
    ...
    Scenarios: all colors correct
        | code    | guess   | mark |
        | r g y c | w g y c | bbbb |
        | r g y c | w g c y | bbww |
        | r g y c | w r g c | bwww |
        | r g y c | w r g y | wwww |
